# Function to compute the highest common factor of two integers

def hcf_calculator(num1, num2):
    """ 
    This function finds the hcf of two numbers.

    It receives two positive integres as inputs and returns an integer as output.
    This fuction also prints out the hcf.
